 ...
 * @author ADMIN
 */
public class CustomerAddresssView extends javax.swing.JFrame {

    /**
     * Creates new form CustomerAddresssView
     */
    CustomerAddressDao localCustomerAddress = new CustomerAddressDao();
    int rowIndex;

    public CustomerAddresssView() {
        initComponents();

        localCustomerAddress.readAllCustomerAddresses(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 120, 530, 30));
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        localCustomerAddress.updateCustomerAddress(localId, address);
        model.setRowCount(0);
        localCustomerAddress.readAllCustomerAddresses(jTable1);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        CustomerAddressCreate createCusAddress = new CustomerAddressCreate();
        createCusAddress.setVisible(true);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        rowIndex = jTable1.getSelectedRow();
        int localId = (int) model.getValueAt(rowIndex, 0);
        localCustomerAddress.deleteCustomerAddress(localId);
        model.setRowCount(0);
        localCustomerAddress.readAllCustomerAddresses(jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerAddresssView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerAddresssView().setVisible(true);
            }
        });
    }
