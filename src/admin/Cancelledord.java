 ...
 * @author ADMIN
 */
public class Cancelledord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Cancelled Orders");
        ...
        jLabel6.setText("Customer Number Phone");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cancelledord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cancelledord().setVisible(true);
            }
        });
    }
