 ...
 * @author ADMIN
 */
public class TakeMoreOdr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(261, 459, Short.MAX_VALUE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeMoreOdr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TakeMoreOdr().setVisible(true);
            }
        });
    }
